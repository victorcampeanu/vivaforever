      ...
      <section id="content" class="content emptyMode">
        ...
        <div class="card compose">
          ...
          <div class="examples" id="examples">
            ...
            <div class="example" data-example="Subiect: Credința, rugăciunea, răbdarea și smerenia în aceste vremuri tulburi\n\nUnghi: Scrie în stil creștin, cald și așezat, despre biserica sfântă, empatie, iubirea de oameni, comunitatea puternică și unită, rădăcini, familie, nădejde, iertare, milostenie, pace sufletească, recunoștință, ajutorarea aproapelui, demnitatea omului, bătrânii singuri, copiii, satul, tradiția vie și parohia ca loc de sprijin. Leagă tema de viața concretă a oamenilor: frică, singurătate, dezbinare, oboseală, nevoia de sprijin și de sens.\n\nTon: religios, luminos, smerit, fără propagandă de partid, fără predică agresivă, fără judecarea oamenilor.\n\nLimite: nu inventa citate biblice; dacă folosești trimiteri religioase, păstrează-le simple și sigure."><b>Credință</b>Rugăciune, răbdare, smerenie și comunitate unită.</div>
            <div class="example" data-example="Subiect: Milostenia și ajutorarea aproapelui într-o societate obosită\n\nUnghi: Scrie despre felul în care credința se vede în fapte mici: grijă pentru bătrâni, vecini, familii încercate, copii și oameni singuri. Arată cum o comunitate creștină puternică poate repara dezbinarea prin răbdare, bunătate și responsabilitate.\n\nTon: cald, religios, concret, fără moralism rece și fără acuzații politice gratuite."><b>Milostenie</b>Credința văzută în ajutorarea aproapelui.</div>
            <div class="example" data-example="Subiect: Iertarea, pacea sufletească și vindecarea dezbinării dintre oameni\n\nUnghi: Scrie despre iertare nu ca slăbiciune, ci ca putere interioară care oprește ura, răzbunarea și înstrăinarea. Leagă tema de familie, comunitate, biserică, răbdare, smerenie și nevoia oamenilor de a se privi din nou cu omenie.\n\nTon: așezat, luminos, profund uman, fără patetism și fără clișee de predică."><b>Iertare</b>Pace sufletească și vindecarea dezbinării.</div>
            <div class="example" data-example="Subiect: Rădăcinile, satul, familia și biserica într-o lume care își pierde reperele\n\nUnghi: Scrie despre rădăcini ca memorie vie, nu nostalgie goală: părinți, bunici, duminică, biserică, muncă cinstită, respect, tradiție și continuitate. Arată de ce o comunitate unită are nevoie de credință, iubire de oameni și responsabilitate între generații.\n\nTon: creștin, demn, cald, fără idealizare falsă și fără atacuri la cei care trăiesc altfel."><b>Rădăcini</b>Familie, sat, biserică și continuitate.</div>
          </div>
        </div>
